    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                ...
                'email' => 'libudang99@gmail.com',
                'password' => bcrypt('darem'),
            ],
            [
                'firstname' => 'WENDY',
                'middlename' => 'HINGPIT',
                ...
                'username' => 'wendy',
                'position' => 'Layout Artist',
                'email' => 'predestined09@gmail.com',
                'password' => bcrypt('wendy'),
            ],
            [
                'firstname' => 'JOHN PAUL',
                'middlename' => 'CUADRILLERO',
                'lastname' => 'PRADAS',
                'username' => 'johnpaul',
                'position' => 'Technical Support',
                'email' => 'ampongofficial@gmail.com',
                'password' => bcrypt('johnpaul'),
            ],
        ];
